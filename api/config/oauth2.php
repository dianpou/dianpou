    ...
    */
    ...
    'grant_types' => [
        'password' => [
            ...
            'callback' => ['\App\Http\Controllers\Auth\AuthController', 'password_grant'],
            'access_token_ttl' => 86400 * 30
        ],
        'guest' => [
            'class' => '\App\Libraries\OAuth\GuestGrant',
            'callback' => ['\App\Http\Controllers\Auth\AuthController', 'guest_grant'],
            'access_token_ttl' => 86400 * 30
        ],
        'openid' => [
            'class' => '\App\Libraries\OAuth\OpenidGrant',
            'callback' => ['\App\Http\Controllers\Auth\AuthController', 'openid_grant'],
            'access_token_ttl' => 86400 * 30
        ],
    ],

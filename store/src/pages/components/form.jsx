...
class Select extends FormsyInput {
  render(){
    var {value, valueLink, onChange, onBlur, label, labelClassName, wrapperClassName, groupClassName, ...other} = this.props;
    var labelHTML;
...
class Input extends FormsyInput {
  render(props = {}){
    var {type, value, valueLink, onChange, onBlur, label, ...other} = this.props;
...
class Button extends React.Component {
  render(){
    var {className, children, pending, pendingMessage, successMessage, ...other} = this.props;
    var text, disabled;
    if (pending) {
      disabled = "disabled";
      text     = pendingMessage ? pendingMessage : 'Pending...';
    } else {
      disabled = null;
      text     = pending === false ? successMessage || children : children;
    }
